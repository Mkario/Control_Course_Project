...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        # self.solutionTitle = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        # self.solutionTitle.setGeometry(QtCore.QRect(0, 0, 10, 50))
        # self.solutionTitle.setAlignment(Qt.AlignTop | Qt.AlignCenter)
        ...
        # content_layout.addWidget(self.solutionTitle)
    ...
    def calculate(self):
        solver = MasonSolver(self.G.adj, self.source, self.destination)
        solver.calculate_transferFunction()

    def setStart(self):
        self.source = self.start.value()
        print(str(self.source) + " is the source")

    def setEnd(self):
        self.destination = self.end.value()
    ...
    def retranslateUi(self, MainWindow):
        ...
        # self.solutionTitle.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:24pt; "
        #                                                     "color:#414141;\">Solution:</span></p></body></html>"))
        self.solution.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:20pt; "
                                                       "color:#414141;\">Add Solution "
